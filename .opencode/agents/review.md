...
You are reviewing changes to an embedded Rust MIDI controller firmware targeting RP2350, and its vanilla JS web configurator UI.
...
- RP2350 target compatibility (GPIO behavior, especially touch pads)
...
- Clippy compliance (run clippy to verify if unsure)
